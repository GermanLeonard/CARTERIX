...
interface SubCategoryRepository {
    ...
    suspend fun createSubCategory(finanzaId: Int?): Flow<Resource<CommonResponseDomain>>
    suspend fun updateSubCategory(subCategoryId: Int): Flow<Resource<CommonResponseDomain>>
}